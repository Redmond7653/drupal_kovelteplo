 ...
 */
final class AccountForm extends ContentEntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state): int {
    ...
    switch ($result) {
      case SAVED_NEW:
        ...
        $this->logger('account')->notice('New account %label has been created.', $logger_args);
        break;

      case SAVED_UPDATED:
        $this->messenger()->addStatus($this->t('The account %label has been updated.', $message_args));
        $this->logger('account')->notice('The account %label has been updated.', $logger_args);
        break;
